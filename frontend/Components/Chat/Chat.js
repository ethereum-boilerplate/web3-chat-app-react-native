...
export default function Chat() {
  ...
  //Subscribe to messsages function
  ...
  //Notify when a message is created function
  const notifyOnCreate = (result) => {
    setUpdated(result)
  }

  //Subscribe to typing function
  ...
  //Notify when someone is typing function
  ...
  //Initialize subscribeToMessages function on load
  useEffect(() => {
    subscribeToMessages();
  }, []);

  //Initialize subscribeToTyping function on load
  useEffect(() => {
    subscribeToTyping(); 
  }, []);

  //Set message state empty on update
  useEffect(() => {
    setMessage('');
  },[updated])

  //Get all messages on update state change
  useEffect(() => {
    getAllMessages();
  }, [updated]);
  ...
  //Get | Create | Update user when typing function
  ...
  //Stop typing after 5 seconds when user types
  useEffect(() => {
    setTimeout(() => {
      stopTyping();
    }, 5000)
      ...
      <KeyboardAvoidingView
        ...
        <View style={styles.scrollViewContainer}>
          <ScrollView style={styles.scrollView}
            ...
            {/* TODO: uncomment these lines of codes to render messages
            ...
            {/* TODO: Uncomment these lines of codes to render typing animation
